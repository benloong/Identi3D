...
#ifndef IDENTI3D_UINTTESTS_MATHTEST_RAY_TEST_H
#define IDENTI3D_UINTTESTS_MATHTEST_RAY_TEST_H
...
namespace Identi3D
{
	...
	{
	public:
		static void testRayTriangleIntersection(void);
		static void testRayPlaneIntersection(void);
		static void testRayAABBIntersection(void);
