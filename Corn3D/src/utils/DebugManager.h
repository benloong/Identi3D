...
#ifndef CORN3D_SRC_UTILS_DEBUGMANAGER_H
#define CORN3D_SRC_UTILS_DEBUGMANAGER_H
...
namespace Corn3D {
	...
	# define DEBUGMANAGER_DEFAULT_FILENAME	__T("corn3d.log")
...
#endif // CORN3D_SRC_UTILS_DEBUGMANAGER_H
